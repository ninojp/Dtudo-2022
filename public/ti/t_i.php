...
<main id="main_conteiner" class="container-fluid">
    <section id="sec_tit_row" class="row">
        <div class="col div_tit_h1ti">
            <h1 class="h1_frase">Dicas, Cursos, apostilas, e-books e muita Informação sobre Tecnologia da informação!</h1>
        </div>
        <div class="col div_parag1_desc1">
    ...
    <section id="sec_hard_soft" class="row">
        <div class="col div_hard">
            <div class="accordion" id="accordion_hard">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="h2_hardware_pc">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#hardware_pc" aria-expanded="true" aria-controls="hardware_pc">Hardware
                        </button>    
                    </h2>
                ...
                <div class="accordion-item">
                    ...
                    <div id="manute_mobile" class="accordion-collapse collapse" aria-labelledby="h2_manute_mobile" data-bs-parent="#accordion_hard">
                        <div class="accordion-body">
                            <strong>Manutenção e reparo de smartphones e Tablets.</strong> Aqui creio eu (não atuo nesta área) que seria necessário trabalhar com as duas plataformas de hardware e software: O Android e Apple iOS, iPhone, iPad. Mesmo assim indico que comece aprendendo Android e seus adjacentes, e depois de dominar (já estiver consertando e configurando bem) passe para linha Apple.
                        </div>
                    </div>
                </div>
                <div class="accordion-item">

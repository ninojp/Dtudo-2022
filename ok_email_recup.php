...
<body>
<?php include('navbarra.php');/* GRID ITEM, pagina externa navbarra.php */
      include('header.php');  ?> 
<main id="main_princ"><!--GRID ITEM -->
<section id="sect_conteiner_form">
	<fieldset>
		<legend>E-Mail de Rucuperação enviado</legend>
			<div class="form-group">
				<h2>O E-Mail com sua senha foi enviado com sucesso!!!</h2>
				<a href="login.php">

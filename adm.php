...
<body>
    <nav class="navbar">
        <div class="navbar_content">
            ...
            <img class="logo" src="imgs/Logo-Dtudo_102x40.png" alt="Logo Dtudo" height="30px">
        </div>
        <div class="navbar_content">
            <i class="fa-solid fa-bell"></i>
            <span class="number">7</span>
            <div class="dropdown_content">
                <li><img src="imgs/TI_link.png" alt="foto do usuário" width="40px"></i>
            ...
            <div class="avatar">
                <img src="imgs/TI_link.png" alt="foto do usuário" width="40px">
